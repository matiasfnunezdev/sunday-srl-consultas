...
async function fetchConversations() {
  const res = await fetch('http://localhost:3000/api/conversations', { cache: 'no-store' }); // Replace with your API endpoint
...
export default async function Page() {
  ...
  return (
    <div className="">
      <h1 className="text-3xl font-bold text-red dark:text-red">Open Conversations</h1>
      <ul>
